...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  ...
  <ul class="navbar-nav">
    ...
    <td><h3>Tambah Siswa | <a href="tampil_siswa.php?" onclick="return confirm('Apakah anda yakin berhenti menambahkan daftar siswa?')" class="btn btn-danger">Keluar</a></td></h3>
